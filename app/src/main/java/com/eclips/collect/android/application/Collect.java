...
package com.eclips.collect.android.application;
...
import com.eclips.collect.android.database.ActivityLogger;
...
import com.eclips.collect.android.utilities.AgingCredentialsProvider;
...
public class Collect extends Application {
    ...
    public static final String ODK_ROOT = Environment.getExternalStorageDirectory()
            + File.separator + "eclips";
    public static final String SYS_MAPS_ROOT = Environment.getExternalStorageDirectory()
            + File.separator + "maps";
    ...
    public static final String DEFAULT_FONTSIZE = "20";
    public static final String OFFLINE_LAYERS = Environment.getExternalStorageDirectory() + File.separator + "maps";
