...
public class GeoODKClassicActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		ImageButton geoodk_map_but = (ImageButton) findViewById(R.id.update_coletor);
		geoodk_map_but.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i = new Intent(getApplicationContext(),	GeoODKMapThemeActivity.class);
				startActivity(i);
				//Context context = GeoODKClassicActivity.this;
		...
		ImageButton geoodk_send_but = (ImageButton) findViewById(R.id.update_geo);
