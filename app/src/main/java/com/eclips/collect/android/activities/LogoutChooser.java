...
import com.eclips.collect.android.listeners.DiskSyncListener;
import com.eclips.collect.android.provider.FormsProviderAPI.FormsColumns;
import com.eclips.collect.android.tasks.DiskSyncTask;
import com.eclips.collect.android.utilities.VersionHidingCursorAdapter;
 ...
 */
public class LogoutChooser extends ListActivity implements DiskSyncListener {

    private static final String t = "LogoutChooser";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.app_name) + " > " + getString(R.string.logout));
