...
import com.eclips.collect.android.exception.JavaRosaException;
import com.eclips.collect.android.listeners.AdvanceToNextListener;
import com.eclips.collect.android.listeners.FormLoaderListener;
import com.eclips.collect.android.listeners.FormSavedListener;
import com.eclips.collect.android.listeners.SavePointListener;
import com.eclips.collect.android.logic.FormController;
import com.eclips.collect.android.logic.FormController.FailedConstraint;
...
import com.eclips.collect.android.provider.FormsProviderAPI.FormsColumns;
import com.eclips.collect.android.provider.InstanceProviderAPI;
import com.eclips.collect.android.provider.InstanceProviderAPI.InstanceColumns;
import com.eclips.collect.android.tasks.FormLoaderTask;
import com.eclips.collect.android.tasks.SavePointTask;
import com.eclips.collect.android.tasks.SaveResult;
import com.eclips.collect.android.tasks.SaveToDiskTask;
import com.eclips.collect.android.utilities.CompatibilityUtils;
import com.eclips.collect.android.utilities.FileUtils;
import com.eclips.collect.android.utilities.MediaUtils;
import com.eclips.collect.android.views.ODKView;
import com.eclips.collect.android.widgets.QuestionWidget;
...
public class FormEntryActivity extends Activity implements AnimationListener,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ImageButton geocallButton = (ImageButton) findViewById(R.id.geoButton);
		geocallButton.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				//Collect.getInstance().getActivityLogger().logAction(this, "Geo Maps Activity", "click");
				Intent i = new Intent("eu.hydrologis.geopaparazzi.maps.MAP_VIEW");
				startActivity(i);
			}
		});
	...
	private void sendSavedBroadcast() {
		Intent i = new Intent();
		i.setAction("com.eclips.collect.android.FormSaved");
